...
class Model(nn.Module):
  def __init__(self, pre_trained = False, decoder = None):
    ...
    # if pre_trained:
    #     pre_trained_weight = torch.load('/mnt/isilon/CSC4/HelenZhouLab/HZLHD1/Data4/Members/yileiwu/wmh_proj/UKBiobank_deep_pretrain/brain_age/run_20190719_00_epoch_best_mae.p', map_location=torch.device('cpu'))
...
if __name__ == '__main__':
    ...
    temp_model = Model(pre_trained=True)
